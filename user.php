...
$ydblock = [""];
$we_stat = false;
$msgwe = "[!] oops sorry".$t."[°] demi keamanan script saya lock sampai kondisi normal";
...
'Lampu Merah','demonz666 last','dlast demonz','Imtitsal Hibatulloh','Agung Arya pratama','Chii Wen','LangBoncezz Boncezz','Mark Engelo','Adrian Tantowi','Fitra Bayu','Sukma Febriani','Ambo Imbi','Adrian Tantowi J','Free Vps Android','Phi Lix','Your Reg','Dova Giovano','agil kholis',
