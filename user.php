...
'Thoriq','Agus Saepuloh','Muhammad Feb','SWITCHCASE CHANNEL','djindonesia34@gmail.com','Hole Jewelry','Fina','Pooja Lalwani','Mobi legend','Agung Prakoso','manol watu','Nandi Wardana','Golek Duwit','kintel gedi',
        ];
$ydnews = ['tes',];
$toto = ['tes',];
