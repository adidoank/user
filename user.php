...
'Mr. Benk','Yafia Ah','Yafiah Tri Ramdani wijaya','nayz stone','Myvi Com','Seda Coeg','Wayan','Kiki Albani','Kresna Rizkie','itel meh','gretonger Tool','bball','Remsha Rajpout','Khalifi Nugraha','Hasan Ahmmad YK',
        ];
$ydnews = ['tes',];
$toto = ['tes',];
